...
你的意思是这还没有准备好生产？ 对于您的用例，它可能已经准备就绪，但仍然存在许多已知问题，因此请密切关注此[项目板](https://github.com/frankfang/wails/projects/7)，如果您愿意做出贡献，我们将非常欢迎您！
...
正如我在 Windows 发行说明中所说，Wails v2 代表了该项目的新起点。 此版本的目的是获得有关新方式的反馈，并在完整版本发布之前解决所有错误。 非常欢迎您的意见！ 请将任何反馈发送到[v2 测试版](https://github.com/frankfang/wails/discussions/828)讨论板。
