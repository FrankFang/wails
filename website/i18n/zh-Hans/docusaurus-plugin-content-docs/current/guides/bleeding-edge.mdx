...
- `git clone https://github.com/frankfang/wails/`
...
`replace github.com/frankfang/wails/v2 => <clonedir>`

示例：

在 Windows 上： `replace github.com/frankfang/wails/v2 => C:\Users\leaan\Documents\wails-v2-beta\wails\v2`

在'nix 上： `replace github.com/frankfang/wails/v2 => /home/me/projects/wails/v2`
