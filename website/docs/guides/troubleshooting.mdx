...
Reference: https://github.com/frankfang/wails/issues/1504#issuecomment-1174317433
...
Credit: https://github.com/frankfang/wails/issues/1186
...
```
"https://proxy.golang.org/github.com/frankfang/wails/cmd/wails/@v/list": dial tcp 172.217.163.49:443: connectex: A connection attempt failed because the connected party did not properly respond after a period of time, or established connection failed because connected host has failed to respond.
```
...
Source: https://github.com/frankfang/wails/issues/1233
...
Source: https://github.com/frankfang/wails/discussions/1512
...
If this isn't completed soon, we will create our own implementation, tracked [here](https://github.com/frankfang/wails/issues/1733).
...
In file included from ../../pkg/mod/github.com/frankfang/wails/v2@v2.0.0-beta.44.2/internal/frontend/desktop/darwin/callbacks.go:9:
...
Source: https://github.com/frankfang/wails/issues/1806
